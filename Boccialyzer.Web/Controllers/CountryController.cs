...
namespace Boccialyzer.Web.Controllers
{
    ...
    public class CountryController : Controller
    {
        ...
        #endregion
        #region # CountryController constructor

        /// <summary>
        /// CountryController constructor
        /// </summary>
        /// <param name="countryRepository">CountryRepository</param>
        ...
        {
            var result = await _countryRepository.GetPaged(pageNumber, pageSize, filter, order);
        ...
        public async Task<IActionResult> Get(string id)
        {
            ...
            var result = await _countryRepository.GetByIdAsync(itemId);
            if (result.Result == OperationResult.Ok) return StatusCode(200, result.Value);
            return StatusCode(422, result.Message);
        }
        ...
        [ProducesResponseType(422)]
        [HttpPut]
        public async Task<IActionResult> Put([FromBody] Country item)
        {
            if (item == null) return StatusCode(422, "Відсутні данні.");
            var result = await _countryRepository.UpdateAsync(item);
        ...
        public async Task<IActionResult> Delete(string id)
        {
            ...
            var result = await _countryRepository.DeleteAsync(itemId);
