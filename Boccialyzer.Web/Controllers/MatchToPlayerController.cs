...
namespace Boccialyzer.Web.Controllers
{
    ...
    [Route("api/MatchToPlayer")]
    [Authorize]
    [ApiController]
    public class MatchToPlayerController : Controller
    {
        #region # Local variables

        private readonly IMatchToPlayerRepository _matchToPlayerRepository;
        ...
        /// Constructor
        /// </summary>
        /// <param name="matchToPlayerRepository"></param>
        public MatchToPlayerController(IMatchToPlayerRepository matchToPlayerRepository)
        {
            _matchToPlayerRepository = matchToPlayerRepository;
        }
        ...
        {
            var result = await _matchToPlayerRepository.GetPaged(pageNumber, pageSize, filter, order);
        ...
        public async Task<IActionResult> Get(string id)
        {
            ...
            var result = await _matchToPlayerRepository.GetByIdAsync(itemId);
            if (result.Result == OperationResult.Ok) return StatusCode(200, result.Value);
            return StatusCode(422, result.Message);
        }
        ...
        public async Task<IActionResult> Delete(string id)
        {
            ...
            var result = await _matchToPlayerRepository.DeleteAsync(itemId);
