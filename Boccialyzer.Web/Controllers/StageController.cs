...
namespace Boccialyzer.Web.Controllers
{
    ...
    public class StageController : Controller
    {
        ...
        /// Constructor
        /// </summary>
        /// <param name="stageRepository"></param>
        ...
        {
            var result = await _stageRepository.GetPaged(pageNumber, pageSize, filter, order);
        ...
        [ProducesResponseType(422)]
        [HttpPut]
        public async Task<IActionResult> Put([FromBody] Stage item)
        {
            if (item == null) return StatusCode(422, "Відсутні данні.");
            var result = await _stageRepository.UpdateAsync(item);
