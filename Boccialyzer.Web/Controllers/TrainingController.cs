...
namespace Boccialyzer.Web.Controllers
{
    ...
    public class TrainingController : Controller
    {
        ...
        {
            var result = await _trainingRepository.GetPaged(pageNumber, pageSize, filter, order);
        ...
        public async Task<IActionResult> Get(string id)
        {
            ...
            var result = await _trainingRepository.GetByIdAsync(itemId);
            if (result.Result == OperationResult.Ok) return StatusCode(200, result.Value);
            return StatusCode(422, result.Message);
        }
        ...
        [ProducesResponseType(422)]
        [HttpPut]
        public async Task<IActionResult> Put([FromBody] Training item)
        {
            if (item == null) return StatusCode(422, "Відсутні данні.");
            var result = await _trainingRepository.UpdateAsync(item);
        ...
        public async Task<IActionResult> Delete(string id)
        {
            ...
            var result = await _trainingRepository.DeleteAsync(itemId);
